...
<section class="delivery-section container">
 ...
 <h3 class="delivery-subtitle">ДОСТАВКА ПО МОСКВЕ И МОСКОВСКОЙ ОБЛАСТИ:</h3>
  <p>1. Изделия габаритами до 180х80х40 см службой доставки <strong>"Яндекс"</strong>, цена до <strong>800 руб.</strong>
  </p><br>

  <p>2. Изделия габаритами выше 180х80х40 см отправляем <strong>почтовыми службами.</strong> Цена от <strong>1300 руб.</strong></p><br>

  <p>3. <strong>Нашей машиной</strong> — один раз в неделю, цена доставки <strong>1500-5000 руб.</strong> в зависимости от габаритов изделия.<br>

  <h3 id="map" class="delivery-subtitle">ДОСТАВКА В РЕГИОНЫ:</h3>
  <p><strong>3–8 дней</strong>, стоимость рассчитывается индивидуально, в среднем 500-1500 руб.</p>

  <h3 class="delivery-subtitle">ПРИ САМОВЫВОЗЕ:</h3>   
  <div class="delivery-blocks">
    <div class="delivery-block">
      <h4>Цех д.Масюгино</h4>
      <p>Пн - сб работает по договоренности при получении товара самовывозом<br>Телефон: <a href="tel:+79226677059">+7 (922) 667‑70‑59</a><br>Воскресенье — выходной.</p>
